...
export class TypescriptFSM implements FSM{    
    ...
    private BuildTransitionTable(){
        ...
        */
        ...
        //AU
        this.AddTransition(TypescriptFSMStates.Initial, TypescriptFSMStates.AU, CharacterCodes.u);
        //AW
        this.AddTransition(TypescriptFSMStates.Initial, TypescriptFSMStates.AW, CharacterCodes.w);
        //AV
        this.AddTransition(TypescriptFSMStates.Initial, TypescriptFSMStates.AV, CharacterCodes.v);
        //AX
        this.AddTransition(TypescriptFSMStates.Initial, TypescriptFSMStates.AX, CharacterCodes.x);
        //AY
        this.AddTransition(TypescriptFSMStates.Initial, TypescriptFSMStates.AY, CharacterCodes.y);
        //AZ
        this.AddTransition(TypescriptFSMStates.Initial, TypescriptFSMStates.AZ, CharacterCodes.z);
